<h1>CommunityMemberBanKickRequest | Root developer documentation</h1>
<header><h1>CommunityMemberBanKickRequest</h1></header><blockquote>
<p><strong>CommunityMemberBanKickRequest</strong>: <code>object</code></p>
</blockquote>
