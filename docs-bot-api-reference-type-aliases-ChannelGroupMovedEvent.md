<h1>ChannelGroupMovedEvent | Root developer documentation</h1>
<header><h1>ChannelGroupMovedEvent</h1></header><blockquote>
<p><strong>ChannelGroupMovedEvent</strong>: <code>object</code></p>
</blockquote>
