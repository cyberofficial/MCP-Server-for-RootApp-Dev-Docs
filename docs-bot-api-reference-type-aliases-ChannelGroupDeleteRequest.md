<h1>ChannelGroupDeleteRequest | Root developer documentation</h1>
<header><h1>ChannelGroupDeleteRequest</h1></header><blockquote>
<p><strong>ChannelGroupDeleteRequest</strong>: <code>object</code></p>
</blockquote>
