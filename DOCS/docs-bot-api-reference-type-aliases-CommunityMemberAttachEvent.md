<h1>CommunityMemberAttachEvent | Root developer documentation</h1>
<header><h1>CommunityMemberAttachEvent</h1></header><blockquote>
<p><strong>CommunityMemberAttachEvent</strong>: <code>object</code></p>
</blockquote>
...
<h3 class="anchor anchorTargetStickyNavbar_Vzrq" id="onlinestatus">onlineStatus<a href="#onlinestatus" class="hash-link" aria-label="Direct link to onlineStatus" title="Direct link to onlineStatus" translate="no">​</a></h3>
<blockquote>
<p><strong>onlineStatus</strong>: <a class="" href="/docs/bot-api-reference/enumerations/UserOnlineStatus/"><code>UserOnlineStatus</code></a></p>
</blockquote>
