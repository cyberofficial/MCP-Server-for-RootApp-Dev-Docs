<h1>CommunityMemberBanDeletedEvent | Root developer documentation</h1>
<header><h1>CommunityMemberBanDeletedEvent</h1></header><blockquote>
<p><strong>CommunityMemberBanDeletedEvent</strong>: <code>object</code></p>
</blockquote>
