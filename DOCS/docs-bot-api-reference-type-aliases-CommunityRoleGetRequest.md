<h1>CommunityRoleGetRequest | Root developer documentation</h1>
<header><h1>CommunityRoleGetRequest</h1></header><blockquote>
<p><strong>CommunityRoleGetRequest</strong>: <code>object</code></p>
</blockquote>
