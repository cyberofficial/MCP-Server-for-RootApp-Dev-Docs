<h1>CommunityMemberBanGetRequest | Root developer documentation</h1>
<header><h1>CommunityMemberBanGetRequest</h1></header><blockquote>
<p><strong>CommunityMemberBanGetRequest</strong>: <code>object</code></p>
</blockquote>
