<h1>ChannelGroupDeletedEvent | Root developer documentation</h1>
<header><h1>ChannelGroupDeletedEvent</h1></header><blockquote>
<p><strong>ChannelGroupDeletedEvent</strong>: <code>object</code></p>
</blockquote>
