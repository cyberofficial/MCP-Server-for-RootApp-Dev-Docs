<h1>CommunityJoinedEvent | Root developer documentation</h1>
<header><h1>CommunityJoinedEvent</h1></header><blockquote>
<p><strong>CommunityJoinedEvent</strong>: <code>object</code></p>
</blockquote>
