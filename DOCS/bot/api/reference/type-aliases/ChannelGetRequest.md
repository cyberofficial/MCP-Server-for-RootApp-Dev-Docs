<h1>ChannelGetRequest | Root developer documentation</h1>
<header><h1>ChannelGetRequest</h1></header><blockquote>
<p><strong>ChannelGetRequest</strong>: <code>object</code></p>
</blockquote>
