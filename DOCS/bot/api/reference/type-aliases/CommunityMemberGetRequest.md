<h1>CommunityMemberGetRequest | Root developer documentation</h1>
<header><h1>CommunityMemberGetRequest</h1></header><blockquote>
<p><strong>CommunityMemberGetRequest</strong>: <code>object</code></p>
</blockquote>
