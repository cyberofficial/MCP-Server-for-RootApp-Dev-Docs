<h1>ChannelFileEditedEvent | Root developer documentation</h1>
<header><h1>ChannelFileEditedEvent</h1></header><blockquote>
<p><strong>ChannelFileEditedEvent</strong>: <code>object</code></p>
</blockquote>
