<h1>CommunityMemberBanDeleteRequest | Root developer documentation</h1>
<header><h1>CommunityMemberBanDeleteRequest</h1></header><blockquote>
<p><strong>CommunityMemberBanDeleteRequest</strong>: <code>object</code></p>
</blockquote>
